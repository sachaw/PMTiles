import { PMTiles, Source, TileType } from "./index.js";
import { Coords, DomUtil, GridLayer } from "leaflet";

export const leafletRasterLayer = (source: PMTiles, options: any) => {
	let loaded = false;
	let mimeType = "";
	const cls = GridLayer.extend({
		createTile: function (coord: Coords, done: any) {
